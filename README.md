...
```bash
mix phx.gen.schema Gallery urls public_url:string compressed_url:string key:string ext:string user_id:references:users
```

Database schema can be generated with <https://hexdocs.pm/ecto_erd/Mix.Tasks.Ecto.Gen.Erd.html> and converted into PNG with `GraphViz`
